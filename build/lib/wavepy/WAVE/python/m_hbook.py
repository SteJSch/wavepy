...
#*CMZ :          29/09/2019  11.11.01  by  Michael Scheer
  ...
  if len(ntname) == 0:
    print("ncread(ntname='', varlis='x:y:z:bx:by:bz', file='ntuple.dat',header=None, skiphead=-1, skipfoot=0, silent=0, comment='*', sep=' ',iguessncols=1")
...
def window_geometry(geom='', fig=-1, set=True):
  global Figgeom, Fig, Tfig, Figman, ScreenWidth, ScreenHeight, Kplots
...
#*CMZ :          28/09/2019  14.39.13  by  Michael Scheer
  ...
  global Tfig, Tax2d, Tax3d, IsameGlobal, ScreenWidth, ScreenHeight, Tdate, Figman
