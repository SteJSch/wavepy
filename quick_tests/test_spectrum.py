...
wave = WaveFromB('wave_from_by') # get a wave instance that calculates from By and Bz

# Get Wave-parameter
paras = wave.get_paras()
# Customize Parameters
paras.field_folder.set('/home/simone/Documents/WavePy/wavepy/examples/Fields/Interpolated/')# Field Folder
paras.field_files.set( [ 'interp_b_field_gap_18.45_.dat'] )# The magnetic field files to be used in the simulation
paras.res_folder.set('/home/simone/Documents/WavePy/wavepy/examples/Spectrum_Results/First_Simu/') # where to store the wave results
